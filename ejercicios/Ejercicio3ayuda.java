...
class MonitorGimnasio {
    ...
    public int entrarPorTorno(int id) throws InterruptedException {
        ...
        try {
            ...
            // Incrementamos el contador de hilos esperando en ese torno al momento de entrar a la cola
            hilosEsperandoTorno[tornoElegido]++;
            // Esperamos en la cola del torno elegido si está ocupado, incrementando el contador de espera
